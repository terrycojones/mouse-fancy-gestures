...
APP_ID = 'lfdlddfebfaofjeihodpahbaiicpjlbp'
codebase = (
    'https://fluiddb.fluidinfo.com/about/mouse-gesture-shortcuts/fluidinfo.com/chrome.crx')
...
print ('Uploaded update manifest for Mouse-Gesture-Shortcuts version %s to '
